def all_db_queries():
    ...
    insert_queries['master'].update({'medlinecitation': '''INSERT INTO Pubmed_Master_Medlinecitation ([PMID]
                    , [Title]
                    , [JournalTitle]
                    , [JournalCountry]
                    , [LinktoPubmed]
                    ...
                    , [ModifiedDate])
                        ...
                        WHERE Pubmed_Medlinecitation.PMID = (?) and Pubmed_Medlinecitation.ID = (?)'''})
