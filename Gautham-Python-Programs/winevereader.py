...
def getAllEvents(server, logtypes, basePath):
    ...
    for logtype in logtypes:
        ...
        path = os.path.join(basePath, logtype)
...
if __name__ == "__main__":
    ...
    logTypes = ["System.csv", "Security.csv", "Directory Service.csv", "Active Directory Web Services.csv", "DFS Replication.csv", "Windows PowerShell.csv", "HardwareEvents.csv"]
    username = os.getlogin()
    getAllEvents(server, logTypes, f"C:\\Users\\{username}\\Documents\\Logs")